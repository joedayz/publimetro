...
public class OfertasCercanasFragment extends Fragment {
    ...
    private static final String TAG = OfertasCercanasFragment.class.getSimpleName();



    private static final String url = "http://www.publiguiaperu.com/servicioweb/servicioWeb2.0.php?token=000&method=getOfertas&idUbicacion=";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.ofertas_cercanas_fragment, container, false);

        ciudad = (Ciudad) getActivity().getIntent().getSerializableExtra("ciudadSeleccionada");

        listView = (ListView) rootView.findViewById(R.id.listview_ofertas_cercanas);
    ...
    private JsonObjectRequest getOfertasCercanas() {
